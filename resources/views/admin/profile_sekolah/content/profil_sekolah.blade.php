<div x-show="activeSection === 'profile'" x-cloak class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden">
    <div class="p-6 md:p-8">
        ...
        <div class="mb-8 border-b border-gray-100 dark:border-gray-800 pb-5">
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Kelola identitas utama, visi, misi, dan informasi umum sekolah untuk ditampilkan pada halaman publik.</p>
        </div>

        <form id="profile-school-form" method="POST" action="{{ route('admin.web_profil.save') }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
            <input type="hidden" name="section" value="profile">
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 rounded-2xl bg-gray-50/50 dark:bg-gray-800/30 border border-gray-100 dark:border-gray-800">
                <!-- Field: Logo Sekolah -->
                <div class="md:col-span-2">
                    <label for="school_logo" class="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">Logo Sekolah</label>
                    @if (empty($profile) || empty($profile->school_logo_path))
                        <input id="school_logo" name="school_logo" type="file" accept="image/*" class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded-l-xl file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-gray-800 dark:file:text-gray-300 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm bg-white dark:bg-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all cursor-pointer">
                        @error('school_logo')
                            <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        <div id="school_logo_preview" class="mt-4 hidden">
                            <div class="flex items-center gap-4">
                                ...
                                <p class="text-xs font-medium text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 px-3 py-1.5 rounded-lg border border-amber-200 dark:border-amber-800/50">Preview logo sebelum disimpan</p>
                            </div>
                        </div>
                    @else
                        <div class="mt-2 flex flex-col sm:flex-row sm:items-center gap-4 bg-white dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm w-max">
                            ...
                            <div class="flex flex-col gap-2">
                                <p class="text-xs font-semibold text-gray-500 dark:text-gray-400">Logo sekolah saat ini</p>
                                <button type="button" onclick="document.getElementById('delete_school_logo_form')?.submit();" class="inline-flex items-center justify-center px-4 py-2 rounded-xl text-xs font-bold text-red-600 bg-white border border-red-200 hover:bg-red-50 dark:bg-transparent dark:border-red-800/50 dark:text-red-400 dark:hover:bg-red-900/20 transition-colors">
                ...
                <div class="md:col-span-1">
                    <label for="school_name" class="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">Nama Sekolah</label>
                    <input id="school_name" name="school_name" type="text" value="{{ old('school_name', $profile->school_name ?? '') }}" class="w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-shadow" placeholder="Contoh: TK Pembina ABA 54 Semarang">
                    @error('school_name')
                        <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <!-- Field: Jumlah Murid -->
                <div class="md:col-span-1">
                    <label for="student_count" class="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">Jumlah Murid</label>
                    <input id="student_count" name="student_count" type="number" min="0" value="{{ old('student_count', $profile->student_count ?? '') }}" class="w-full rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm transition-shadow" placeholder="Contoh: 350">
                    @error('student_count')
                        <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                ...
                <!-- Field: Selamat Datang -->
                <div>
                    <label for="welcome_message" class="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">Kata Sambutan (Selamat Datang)</label>
                    <div class="w-full border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-900 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-shadow">
                        <div class="flex flex-wrap items-center gap-1 border-b border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-800/50 p-2" data-rtf-toolbar data-target="welcome_message_editor">
                        ...
                        <div id="welcome_message_editor" data-rich-editor data-target-input="welcome_message" contenteditable="true" class="rich-editor-content prose dark:prose-invert max-w-none w-full min-h-[200px] p-5 text-gray-800 dark:text-gray-200 outline-none">{!! old('welcome_message', $profile->welcome_message ?? '') !!}</div>
                    </div>
                ...
                <!-- Field: Visi -->
                <div>
                    <label for="vision" class="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">Visi Sekolah</label>
                    <div class="w-full border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-900 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-shadow">
                        <div class="flex flex-wrap items-center gap-1 border-b border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-800/50 p-2" data-rtf-toolbar data-target="vision_editor">
                            <select data-editor-format class="text-sm border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 py-1.5 pl-2 pr-8 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                <option value="P">Normal Paragraf</option>
                                <option value="H1">Heading 1</option>
                                <option value="H2">Heading 2</option>
                        ...
                        <div id="vision_editor" data-rich-editor data-target-input="vision" contenteditable="true" class="rich-editor-content prose dark:prose-invert max-w-none w-full min-h-[150px] p-5 text-gray-800 dark:text-gray-200 outline-none">{!! old('vision', $profile->vision ?? '') !!}</div>
                    </div>
                ...
                <!-- Field: Misi -->
                <div>
                    <label for="mission" class="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">Misi Sekolah</label>
                    <div class="w-full border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-900 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-shadow">
                        <div class="flex flex-wrap items-center gap-1 border-b border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-800/50 p-2" data-rtf-toolbar data-target="mission_editor">
                            <select data-editor-format class="text-sm border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 py-1.5 pl-2 pr-8 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                <option value="P">Normal Paragraf</option>
                                <option value="H1">Heading 1</option>
                                <option value="H2">Heading 2</option>
                        ...
                        <div id="mission_editor" data-rich-editor data-target-input="mission" contenteditable="true" class="rich-editor-content prose dark:prose-invert max-w-none w-full min-h-[220px] p-5 text-gray-800 dark:text-gray-200 outline-none">{!! old('mission', $profile->mission ?? '') !!}</div>
                    </div>
                ...
                <!-- Field: Tujuan (Profil Tambahan) -->
                <div>
                    <label for="school_profile" class="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-1.5">Tujuan (Deskripsi Sekolah)</label>
                    <div class="w-full border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden bg-white dark:bg-gray-900 shadow-sm focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 transition-shadow">
                        <div class="flex flex-wrap items-center gap-1 border-b border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-gray-800/50 p-2" data-rtf-toolbar data-target="school_profile_editor">
                            <select data-editor-format class="text-sm border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 py-1.5 pl-2 pr-8 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                <option value="P">Normal Paragraf</option>
                                <option value="H1">Heading 1</option>
                                <option value="H2">Heading 2</option>
                        ...
                        <div id="school_profile_editor" data-rich-editor data-target-input="school_profile" contenteditable="true" class="rich-editor-content prose dark:prose-invert max-w-none w-full min-h-[200px] p-5 text-gray-800 dark:text-gray-200 outline-none">{!! old('school_profile', $profile->school_profile ?? '') !!}</div>
                    </div>
            ...
            <div class="flex items-center justify-end pt-5 border-t border-gray-100 dark:border-gray-800">
                <button id="save-profile-school-button" type="submit" form="profile-school-form" class="inline-flex items-center justify-center px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-sm shadow-md shadow-blue-500/20 transition-all focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 w-full md:w-auto">
