...
@section('content')
	...
	<article class="p-4 md:p-5 xl:p-8 border-b border-gray-200 dark:border-gray-700 xl:border-b-0">
		<a href="{{ route('app.berita.home') }}" class="inline-flex items-center gap-2 text-xs font-semibold text-sky-700 dark:text-sky-300 hover:underline mb-3">
			<i class="fa-solid fa-arrow-left"></i>
			Kembali ke Home Berita
		</a>
	...
	<section class="p-4 md:p-5 xl:p-0 bg-gray-50 dark:bg-gray-900/40 xl:bg-transparent xl:dark:bg-transparent transition-colors duration-300 xl:sticky xl:top-28 h-fit">
		...
		<div class="space-y-3">
			@forelse($recentBeritas as $item)
				<a href="{{ route('app.berita.show', $item) }}" class="flex gap-3 items-start rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-2.5 hover:border-sky-300 dark:hover:border-sky-600 transition-colors">
